...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "null,+94701479831";
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "+94701479831,+94701479831";
...
// ========================= [ Disables in V.1.2.8 ] ===============================\\  
  ...
  //alwaysonline:process.env.WAPRESENCE|| "available", // 'available' | 'online' | 'composing' | 'recording' | 'open'
  //read_status: process.env.AUTO_READ_STATUS || "tru",
